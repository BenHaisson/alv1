...
export default function LuxuryHeader({ onNavClick, activeSection = "" }: LuxuryHeaderProps) {
  ...
  return (
    <>
      <header className="fixed left-0 right-0 top-0 z-40 h-[76px] border-b border-[rgba(234,222,206,0.18)] bg-[rgba(10,10,10,0.92)] md:h-14 md:bg-[rgba(10,10,10,0.86)] luxury-noise">
